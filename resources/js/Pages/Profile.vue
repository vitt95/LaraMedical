                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body text-center">
                        <img
                            ...
                            height="128"
                        />
                        <h5 v-if="user !== undefined" class="card-title mb-0">{{user.name +' '+ user.lastname}}</h5>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="mb-1">
                                ...
                                ></span>
                                Lives in <a href="#">{{user.address}}</a>
                            </li>
                ...
                <div class="card">
                    ...
                    <div class="card-body h-100">
                        <div class="d-flex align-items-start">
                            <img
                                src="https://demo-basic.adminkit.io/img/avatars/avatar-5.jpg"
                                width="36"
                                height="36"
                        ...
                        <div class="d-flex align-items-start">
                            <img
                                src="https://demo-basic.adminkit.io/img/avatars/avatar.jpg"
                                width="36"
                                height="36"
                                class="rounded-circle me-2"
                                alt="Charles Hall"
                        ...
                        <div class="d-flex align-items-start">
                            <img
                                src="https://demo-basic.adminkit.io/img/avatars/avatar-2.jpg"
                                width="36"
                                height="36"
                                class="rounded-circle me-2"
                                alt="William Harris"
                        ...
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-start mt-1">
                                    <a class="pe-3" href="#">
                                        <img
                                            src="https://demo-basic.adminkit.io/img/avatars/avatar"
                                            width="36"
                                            height="36"
                                            class="rounded-circle me-2"
                                            alt="Christina Mason"
